...
/* ---------------------------------------------------------------
 *  TASK RETRIEVAL ROUTES (BY ID / PROJECT / SPRINT)
 * ------------------------------------------------------------- */
// GET /api/tasks/:id
...
/* ---------------------------------------------------------------
 *  CHAT  ROUTES  (OpenAI streaming, chat tabs, history, etc.)
 * ------------------------------------------------------------- */
...
/* ---------------------------------------------------------------
 *  STERLING CHAT  (UPDATED ENDPOINT)
 * ------------------------------------------------------------- */
...
app.post("/api/createSterlingChat", async (req, res) => {
  ...
  try {
    ...
    // Call Sterling’s API to create the chat
